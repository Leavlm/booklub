...
<section>
    <a href="product-page.php?id=<?= $book['id_book'] ?>"><i class="fa-solid fa-arrow-left review__arrow"></i></a>
        ...
        <form method="POST" action="action.php" class="review__wrap">
            ...
            <div>
                ...
                <div class="form-floating">
                    <textarea class="form-control" placeholder="Laissez un commentaire ici" id="floatingTextarea" name="comment_ranking" rows="40"></textarea>
                    <label class="label-js for  m-label" for="floatingTextarea">Commentaire</label>
                </div>
